...
import adapter.SelectedRecycleAdapter;
import adapter.UnSelectedRecycleAdapter;
...
public class MentManageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.mentmanage);
        ...
        mSelectedAdatper.setOnItemClickListener(new SelectedRecycleAdapter.OnItemClickListener() {
            ...
            public void onItemClickListener(SelectedRecycleAdapter.MyViewHolder viewHolder, int pos) {
                if (!isDeleteIconsShow) {
                    Toast.makeText(MentManageActivity.this, mSelectedDatas.get(pos), Toast.LENGTH_SHORT).show();
                }
            }
